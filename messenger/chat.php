...
async function loadMessages() {
    ...
    try {
        const res = await fetch(`/includes/plugins/messenger/messenger.php?receiverId=${activeUser}`);
...
async function loadNewMessages() {
    ...
    try {
        const res = await fetch(`/includes/plugins/messenger/messenger.php?receiverId=${activeUser}&afterId=${lastMessageId}`);
        const messages = await res.json();
...
async function sendMessage() {
    ...
    try {
        const res = await fetch('/includes/plugins/messenger/messenger.php', {
            method: 'POST',
            headers: {'Content-Type':'application/json'},
