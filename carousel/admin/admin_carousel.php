...
if (isset($_POST[ 'sortieren' ])) {
    ...
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
        ...
        if (is_array($sort)) {
            foreach ($sort as $sortstring) {
                ...
                safe_query("UPDATE plugins_carousel SET sort='$sorter[1]' WHERE carouselID='$sorter[0]' ");
    ...
    $CAPCLASS = new \webspell\Captcha;
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
    safe_query("INSERT INTO plugins_carousel (title, link, time_pic, description, displayed, sort) values ('".$title."', '".$link."', '".$time_pic."', '".$description."', '".intval($displayed)."','1')");
                ...
                if ($upload->supportedMimeType($mime_types)) {
                    ...
                    if (is_array($imageInformation)) {
                        ...
                        if ($upload->saveAs($filepath.$file, true)) {
                            ...
                            safe_query(
                                "UPDATE plugins_carousel SET carousel_pic='" . $file . "' WHERE carouselID='" . $id . "'"
                            );
                        }
                    } else {
         ...
         if ($upload->hasError() === false) {
            ...
            if ($upload->supportedMimeType($mime_types)) {
                ...
                if ($upload->saveAs($filepathvid . $file, true)) {
                    ...
                    safe_query(
                        "UPDATE plugins_carousel SET carousel_vid='" . $file . "' WHERE carouselID='" . $id . "'"
                    );
                }
            } else {
    ...
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
        ...
        safe_query(
            "UPDATE plugins_carousel SET title='" . $title . "', time_pic='" . $time_pic . "', ani_title='" . $ani_title . "', link='" . $link . "', ani_link='" . $ani_link . "', description='" . $description .
    ...
    if ($CAPCLASS->checkCaptcha(0, $_GET[ 'captcha_hash' ])) {
        $get = safe_query("SELECT * FROM plugins_carousel WHERE carouselID='" . $_GET[ "carouselID" ] . "'");
        $data = mysqli_fetch_assoc($get);
 
        if (safe_query("DELETE FROM plugins_carousel WHERE carouselID='" . $_GET[ "carouselID" ] . "'")) {
    ...
    $CAPCLASS = new \webspell\Captcha;
    if ($CAPCLASS->checkCaptcha(0, $_GET[ 'captcha_hash' ])) {
        $get = safe_query("SELECT * FROM plugins_carousel_parallax WHERE parallaxID='" . $_GET[ "parallaxID" ] . "'");
        $data = mysqli_fetch_assoc($get);
 
        if (safe_query("DELETE FROM plugins_carousel_parallax WHERE parallaxID='" . $_GET[ "parallaxID" ] . "'")) {
    ...
    $CAPCLASS = new \webspell\Captcha;
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
    safe_query("INSERT INTO `plugins_carousel_parallax` (text) values ('parallax')");
                ...
                if ($upload->supportedMimeType($mime_types)) {
                    ...
                    if (is_array($imageInformation)) {
                        ...
                        if ($upload->saveAs($filepath.$file, true)) {
                            @chmod($file, $new_chmod);
                            safe_query(
                                "UPDATE plugins_carousel_parallax SET parallax_pic='" . $file . "' WHERE parallaxID='" . $id . "'"
                            );
                        }
    ...
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
        ...
        #safe_query(
        #    "UPDATE plugins_parallax SET height='" . $height . "' WHERE headerID='" . $_POST[ "headerID" ] . "'");
    ...
    $CAPCLASS = new \webspell\Captcha;
    if ($CAPCLASS->checkCaptcha(0, $_GET[ 'captcha_hash' ])) {
        $get = safe_query("SELECT * FROM plugins_carousel_sticky WHERE stickyID='" . $_GET[ "stickyID" ] . "'");
        $data = mysqli_fetch_assoc($get);
 
        if (safe_query("DELETE FROM plugins_carousel_sticky WHERE stickyID='" . $_GET[ "stickyID" ] . "'")) {
    ...
    $CAPCLASS = new \webspell\Captcha;
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
    safe_query("INSERT INTO `plugins_carousel_sticky` (title, description, link) values ('".$title."', '".$description."', '".$link."')");
                ...
                if ($upload->supportedMimeType($mime_types)) {
                    ...
                    if (is_array($imageInformation)) {
                        ...
                        if ($upload->saveAs($filepath.$file, true)) {
                            @chmod($file, $new_chmod);
                            safe_query(
                                "UPDATE plugins_carousel_sticky SET sticky_pic='" . $file . "' WHERE stickyID='" . $id . "'"
                            );
                        }
    ...
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
        ...
        safe_query(
            "UPDATE plugins_carousel_sticky SET title='" . $title . "', description='" . $description . "', link='" . $link . "' WHERE stickyID='" . $_POST[ "stickyID" ] . "'");
...
##########################
    ...
    $CAPCLASS = new \webspell\Captcha;
    if ($CAPCLASS->checkCaptcha(0, $_GET[ 'captcha_hash' ])) {
        $get = safe_query("SELECT * FROM plugins_carousel_agency WHERE agencyID='" . $_GET[ "agencyID" ] . "'");
        $data = mysqli_fetch_assoc($get);
 
        if (safe_query("DELETE FROM plugins_carousel_agency WHERE agencyID='" . $_GET[ "agencyID" ] . "'")) {
    ...
    $CAPCLASS = new \webspell\Captcha;
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
    safe_query("INSERT INTO `plugins_carousel_agency` (title, description, link) values ('".$title."', '".$description."', '".$link."')");
                ...
                if ($upload->supportedMimeType($mime_types)) {
                    ...
                    if (is_array($imageInformation)) {
                        ...
                        if ($upload->saveAs($filepath.$file, true)) {
                            @chmod($file, $new_chmod);
                            safe_query(
                                "UPDATE plugins_carousel_agency SET agency_pic='" . $file . "' WHERE agencyID='" . $id . "'"
                            );
                        }
    ...
    if ($CAPCLASS->checkCaptcha(0, $_POST[ 'captcha_hash' ])) {
        ...
        safe_query(
            "UPDATE plugins_carousel_agency SET title='" . $title . "', description='" . $description . "', link='" . $link . "' WHERE agencyID='" . $_POST[ "agencyID" ] . "'");
...
if ($action == "add_vid") {
  ...
  <div class="mb-3 row">
    ...
    $ds = mysqli_fetch_array(
        safe_query(
            "SELECT * FROM plugins_carousel WHERE carouselID='" . intval($_GET['carouselID']) ."'"
        )
    );
...
<div class="card-body">';
    ...
    $ds = mysqli_fetch_array(
        safe_query(
            "SELECT * FROM plugins_carousel_parallax WHERE parallaxID='" . intval($_GET['parallaxID']) ."'"
        )
    );
...
<div class="card-body">';
    ...
    $ds = mysqli_fetch_array(
        safe_query(
            "SELECT * FROM plugins_carousel_sticky WHERE stickyID='" . intval($_GET['stickyID']) ."'"
        )
    );
...
<div class="card-body">';
    ...
    $ds = mysqli_fetch_array(
        safe_query(
            "SELECT * FROM plugins_carousel_agency WHERE agencyID='" . intval($_GET['agencyID']) ."'"
        )
    );
...
if (isset($ds['parallaxID']) ? isset($ds['parallaxID']) : 0) {  
   ...
   $CAPCLASS = new \webspell\Captcha;
    ...
    $qry = safe_query("SELECT * FROM plugins_carousel_parallax");
...
if (isset($ds['stickyID']) ? isset($ds['stickyID']) : 0) {  
   ...
   $CAPCLASS = new \webspell\Captcha;
    ...
    $qry = safe_query("SELECT * FROM plugins_carousel_sticky");
    $anz = mysqli_num_rows($qry);
    if ($anz) {
        $i = 1;
        while ($dx = mysqli_fetch_array($qry)) {
...
if (isset($ds['agencyID']) ? isset($ds['agencyID']) : 0) {  
   ...
   $CAPCLASS = new \webspell\Captcha;
    ...
    $qry = safe_query("SELECT * FROM plugins_carousel_agency");
    $anz = mysqli_num_rows($qry);
    if ($anz) {
        $i = 1;
        while ($dx = mysqli_fetch_array($qry)) {
...
<!-- Modal END -->
    ...
    $settings = safe_query("SELECT * FROM plugins_carousel_settings");
...
<div class="mb-3 row">
   ...
   $CAPCLASS = new \webspell\Captcha;
    ...
    $qry = safe_query("SELECT * FROM plugins_carousel ORDER BY sort");
    $anz = mysqli_num_rows($qry);
    if ($anz) {
        $i = 1;
