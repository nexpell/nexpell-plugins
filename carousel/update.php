...
$transaction .= addtable("CREATE TABLE IF NOT EXISTS plugins_carousel (
...
$transaction .= add_insert_table("INSERT IGNORE INTO plugins_carousel (`carouselID`, `title`, `ani_title`, `link`, `ani_link`, `description`, `ani_description`, `carousel_pic`, `carousel_vid`, `time_pic`, `sort`, `displayed`) VALUES
...
$transaction .= addtable("CREATE TABLE IF NOT EXISTS plugins_carousel_parallax (
...
$transaction .= add_insert_table("INSERT IGNORE INTO plugins_carousel_parallax (`parallaxID`, `parallax_pic`, `text`) VALUES
(1, 'parallax.jpg', 'parallax')");

$transaction .= addtable("CREATE TABLE IF NOT EXISTS plugins_carousel_sticky (
...
$transaction .= add_insert_table("INSERT IGNORE INTO plugins_carousel_sticky (`stickyID`, `sticky_pic`, `title`, `description`, `link`) VALUES
...
$transaction .= addtable("CREATE TABLE IF NOT EXISTS plugins_carousel_agency (
...
$transaction .= add_insert_table("INSERT IGNORE INTO plugins_carousel_agency (`agencyID`, `agency_pic`, `title`, `description`, `link`) VALUES
...
$transaction .= addtable("CREATE TABLE IF NOT EXISTS plugins_carousel_settings (
  `carouselID` int(11) NOT NULL AUTO_INCREMENT,
...
$transaction .= add_insert_table("INSERT IGNORE INTO plugins_carousel_settings (`carouselID`, `carousel_height`, `parallax_height`, `sticky_height`, `agency_height`) VALUES
(1, '75vh', '75vh', '75vh', '75vh')");

## SYSTEM #####################################################################################################################################

$transaction .= add_insert_plugin("INSERT IGNORE INTO settings_plugins (`pluginID`, `name`, `modulname`, `info`, `admin_file`, `activate`, `author`, `website`, `index_link`, `hiddenfiles`, `version`, `path`, `status_display`, `plugin_display`, `widget_display`, `delete_display`, `sidebar`) VALUES
...
$transaction .= add_insert_plugins_widget("INSERT IGNORE INTO settings_plugins_widget (`id`, `modulname`, `widgetname`, `widgetdatei`, `area`) VALUES
...
$transaction .= add_insert_navi_dashboard("INSERT IGNORE INTO navigation_dashboard_links (`linkID`, `catID`, `name`, `modulname`, `url`, `sort`) VALUES
